...
echo ""
echo "=== Build Complete ==="
echo "The .deb package is at: ../openbrowser_0.1-1_$(dpkg-architecture -qDEB_BUILD_ARCH).deb"
echo ""
echo "Install with:"
echo "  sudo dpkg -i ../openbrowser_0.1-1_$(dpkg-architecture -qDEB_BUILD_ARCH).deb"
